...
Invoke-NativeGate '== Phase 8.2.1: format ==' { dart format lib test }
Invoke-NativeGate '== Phase 8.2.1: analyze ==' { flutter analyze }

Write-Host '== Phase 8.2.1: professional zoom regressions ==' -ForegroundColor Cyan
...
Write-Host '== Phase 8.2.1: photo/overlay/location/video guards ==' -ForegroundColor Cyan
...
Invoke-NativeGate '== Phase 8.2.1: full tests ==' { flutter test }
Invoke-NativeGate '== Phase 8.2.1: Android debug build ==' { flutter build apk --debug }

Write-Host 'Phase 8.2.1 automated gate PASS. Verify 1x->max->1x pinch, slow pinch, fast pinch, tap-reset animation, and repeated photo capture on a physical device.' -ForegroundColor Green
